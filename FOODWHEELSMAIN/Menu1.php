...
<body>
	<section class="header">
	 ...
	 <section class="pricing-table">
			<div class="container">
				<div class="row">
					<h1 class="text-c"><span class="r-heading">Here our's Combo Pacages </span><span class="r-heading1"></br></br></br>You Can try it,Login to Order More and get More</span> </h1>
					...
					<div class="col-md-4 pricing-box pricing-details">
						<div class="pricing-border">
							...
							<button type="button" class="login-btn" style="background-color: crimson;"><a href="login.php" style="">To Make the Order You Have to Log In</a></button>
						</div>
					</div>
