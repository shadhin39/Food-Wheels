			 		...
			 		<div class="col-md-6 contact-info">
			 			  <div class="signoutButton" >
			 				...
			 				<ul class="list-inline">
			 					...
			 					<button type="button" class="logout-btn" name="Logout" value="Logout" style="background-color: crimson"><a href="logout.php">Logout</a></button>
			 			...
			 			<div class="social-info">
			 				<ul class="list-inline">
								...
								<br><li class="contact-number">Contact US:+880167-3577514</li>
								<?php
$email=$_SESSION['email'];

$conn = mysqli_connect("localhost", "root", "", "foodwheels");
// Check connection
if ($conn->connect_error) {
die("Connection failed: " . $conn->connect_error);
}
$sql = "SELECT * FROM rest WHERE email='$email'";
...
echo "<h5>Name :</h5>".$row["firstname"];
echo "  ".$row["secondname"];
echo "<br></br><h5>Email :</h5>".$row["email"];

echo "<br></br><h5>Contact number :</h5>".$row["number"];

echo "<br></br><h5>Address :</h5>".$row["address"];

echo "<br></br><h5>Gender:</h5>".$row["gender"];
